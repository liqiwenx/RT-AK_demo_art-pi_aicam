...
#ifndef __AI_PERSON_DECT_H__
#define __AI_PERSON_DECT_H__
#pragma once

#include "ai_platform.h"
#include "ai_platform_interface.h"

#define AI_PERSON_DECT_MODEL_NAME          "person_dect"

#define AI_PERSON_DECT_ACTIVATIONS_ALIGNMENT   (4)

#define AI_PERSON_DECT_IN_NUM       (1)
#define AI_PERSON_DECT_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_S8, 96, 96, 3, 1, NULL), \
}
#define AI_PERSON_DECT_IN_SIZE { \
  (96 * 96 * 3), \
}
#define AI_PERSON_DECT_IN_1_SIZE  (96 * 96 * 3)
#define AI_PERSON_DECT_IN_1_SIZE_BYTES  ((96 * 96 * 3) * 1)





#define AI_PERSON_DECT_OUT_NUM      (1)
#define AI_PERSON_DECT_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_S8, 1, 1, 2, 1, NULL), \
}
#define AI_PERSON_DECT_OUT_SIZE { \
  (1 * 1 * 2), \
}
#define AI_PERSON_DECT_OUT_1_SIZE  (1 * 1 * 2)
#define AI_PERSON_DECT_OUT_1_SIZE_BYTES  ((1 * 1 * 2) * 1)

#define AI_PERSON_DECT_N_NODES (31)

AI_API_DECLARE_BEGIN

/*!
 * @defgroup person_dect
 ...
 * @ref ai_person_dect_create. Both the activations memory buffer 
 ...
 * using @ref ai_person_dect_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_PERSON_DECT_*
 * defines into file @ref person_dect.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_person_dect_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /*__AI_PERSON_DECT_H__*/
